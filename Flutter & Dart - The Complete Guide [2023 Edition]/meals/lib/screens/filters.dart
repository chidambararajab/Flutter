...
class _FiltersScreenState extends State<FiltersScreen> {
  ...
  void initState() {
    super.initState();
    _isGlutenFree = widget.currentFilters[Filter.isGlutenFree]!;
    _isLactoseFree = widget.currentFilters[Filter.isLactoseFree]!;
    _isVeg = widget.currentFilters[Filter.isVeg]!;
    _isVegan = widget.currentFilters[Filter.isVegan]!;
  }
